...
1. **Write the content** following this structure (adapt as needed):
...
2. **Add images/diagrams** only if the user provides them or they can be described as placeholders:
